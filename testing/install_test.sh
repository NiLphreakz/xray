...
wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/NiLphreakz/xray/main/testing/nginx.conf
domain=$(cat /usr/local/etc/xray/dns/domain)
...
cd /usr/bin
GITHUB=raw.githubusercontent.com/NiLphreakz/xray/maintesting/
