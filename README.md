...
**Link Instalasi**
```
bash -c "$(wget -qO- https://raw.githubusercontent.com/NiLphreakz/xray/main/install.sh)"
```
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/NiLphreakz/xray/main/install.sh)"
```
