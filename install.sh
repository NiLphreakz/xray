...
apt install python3-psutil python3-pandas python3-tabulate python3-rich python3-cpuinfo python3-distro python3-requests python3-pycountry python3-geoip2
check_success
sleep 1
...
# Mengatur zona waktu ke Asia/Kuala_Lumpur
print_msg $YB "Mengatur zona waktu ke Asia/Kuala_Lumpur..."
sudo timedatectl set-timezone Asia/Kuala_Lumpur &>/dev/null
...
wget -q -O /usr/local/bin/wireproxy https://github.com/NiLphreakz/xray/raw/main/wireproxy
...
XRAY_CONFIG=raw.githubusercontent.com/NiLphreakz/xray/mainconfig
...
wget -q -O /var/www/html/index.html https://raw.githubusercontent.com/NiLphreakz/xray/main/index.html
wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/NiLphreakz/xray/main/nginx.conf
...
cd /usr/bin
GITHUB=raw.githubusercontent.com/NiLphreakz/xray/main
